...
To perform an evaluation of the possible scenarios in a sequence-to-sequence (Seq2Seq) time series, noise is included randomly. Using this data, it is possible to evaluate the original signal (original), as well as two possible scenarios with higher noise intensity (x1 and x2), as can be seen:
